...
def readsnap(sdir,snum,simulation_name,ptype,file_number,
    ...
    fname,fname_base,fname_ext = check_if_filename_exists(sdir,snum,simulation_name,file_number,\
...
def check_if_filename_exists(sdir,snum,simulation_name,file_number,snapshot_name='snapshot',extension='.hdf5',four_char=0):
